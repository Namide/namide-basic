package namide.tools.lightSlideshow.transitions 
{
	 ...
	 */
	public class PictureTransitionFadeSimple implements PicturesTransition 
	{
		[Embed("shader/transitionFadeSimple.pbj", mimeType="application/octet-stream")]
		...
		public function PictureTransitionFadeSimple( w:int, h:int ) 
		{			
			_content = new Bitmap();
